...
import { Settings, Shield, MapPin, DollarSign, Building, Save, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="bg-white p-6 rounded-3xl shadow-md border border-slate-200/80 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Configure company profile, attendance parameters & security policies</p>
        </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 px-6 py-3.5 bg-[#0a192f] hover:bg-[#1d4ed8] text-white text-xs font-black rounded-2xl shadow-lg transition-all"
          >
